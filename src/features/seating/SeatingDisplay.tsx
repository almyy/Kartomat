      ...
      {seatingResult && (
        <>
          {seatingResult.success && seatingResult.seating ? (
            <>
              <div className="flex justify-end mb-4 mt-3 sm:mt-4">
            ...
            <div className="bg-red-500/20 border border-red-500/50 px-3 sm:px-4 py-3 sm:py-4 rounded text-red-400 text-sm sm:text-base mt-3 sm:mt-4">
