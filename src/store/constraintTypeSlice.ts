...
export interface ConstraintTypeSlice {
  ...
  setConstraintType: (type: typeof CONSTRAINT_TYPES[keyof typeof CONSTRAINT_TYPES]) => void
}

export const createConstraintTypeSlice: StateCreator<ConstraintTypeSlice> = (set) => ({
