...
import { addStudents, configureClassroom, addTogetherConstraint, solveSeating, verifyStudentInSeating, getStudentPosition, areAdjacent } from './test-helpers';
...
test.describe('Must Be Together Constraint', () => {
  ...
  test('should handle conflicting together constraints with solution', async ({ page }) => {
    await configureClassroom(page, 2, 3);
