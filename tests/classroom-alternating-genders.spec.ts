...
test.describe('Classroom Alternating Genders', () => {
  ...
  test('should alternate genders in seats when button is clicked', async ({ page }) => {
    ...
    const seatButtons = classroomRegion.locator('button[title*="Tilgjengelig sete"], button[title*="Available seat"]');
  ...
  test('should maintain alternating pattern after multiple clicks', async ({ page }) => {
